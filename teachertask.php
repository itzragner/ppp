...
//             echo "id: " . $row["task_title"] . $row["teachertask_name"]. $row["description"]. $row["id_groupetask"]. "<br>";
...
<script>
    $(document).ready(function() {
        ...
        $('#teachertabletasks').DataTable({
        columnDefs: [
            {  "targets": [0], "searchable": false, "orderable": false} ,{"visible": true }
        ],
        order: [[ 1,'asc']],
        "oLanguage": {
        "sEmptyTable": "no data found tasks TEACHER" 
    },
        language: { 
            search:"",
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="table-responsive table mt-2" id="dataTable" role="grid" >
                                <table class="table my-0 table-striped" id="teachertabletasks">
                                    <thead>
                                        <tr>
